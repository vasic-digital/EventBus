#!/usr/bin/env bash
# eventbus_compile_challenge.sh - Validates EventBus module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.eventbus"
if grep -q "^module digital.vasic.eventbus$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.eventbus"
else
...
# Test 8: No compilation errors in any package
