# EventBus - A generic, reusable Go module for publish/subscribe event-driven communication with typed events, filtering, and middleware.
# Module: digital.vasic.eventbus
...
challenge:
	../challenges/scripts/eventbus_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "EventBus - A generic, reusable Go module for publish/subscribe event-driven communication with typed events, filtering, and middleware."
	@echo ""
	@echo "Build & Test:"
